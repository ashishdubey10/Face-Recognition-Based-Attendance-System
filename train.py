...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=50  ,height=4  ,font=('times', 15, ' bold '))
message2.place(x=550, y=600)
